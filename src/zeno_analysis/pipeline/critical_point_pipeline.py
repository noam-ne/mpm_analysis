...
from zeno_analysis.data_types.analysis_result import ZenoAnalysisResult, SqrtFitResult
from zeno_analysis.analysis.critical_point import (
...
class CriticalPointPipeline:
    ...
    def save(
        ...
        *,
        ...
        from zeno_analysis.io.analysis_json import augment_json_with_sqrt_fit
